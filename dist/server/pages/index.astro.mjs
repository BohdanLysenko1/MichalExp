/* empty css                                 */
import { c as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, d as renderComponent } from '../chunks/astro/server_B-ZIt8ph.mjs';
import 'kleur/colors';
import { $ as $$BaseLayout, a as $$SimpleFooter } from '../chunks/SimpleFooter_DW905uHX.mjs';
import 'clsx';
...
<\/script>`])), maybeRenderHead(), Array(9).fill(0).map((_, i) => renderTemplate`<button${addAttribute(`w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full ${i === 0 ? "bg-white active" : "bg-white/50 hover:bg-white"} carousel-indicator`, "class")}${addAttribute(i, "data-index")}${addAttribute(`Go to slide ${i + 1}`, "aria-label")}></button>`));
